...
/**
 * POPULATE DEV_SUP_DATABASE_URL WITH CORRECT COLUMN NAMES
 * Fixed column names to match actual schema
 */

import postgres from 'postgres';

console.log('🚀 POPULATING DEVELOPMENT DATABASE (CORRECT COLUMNS)');
console.log('===================================================');
...
try {
  ...
  // 2. Create agents with correct column names from schema
  console.log('\n📊 Creating AI agents...');
  await client`
