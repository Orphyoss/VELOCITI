            ...
            {showAnalysis && (
              <div className="bg-dark-800/30 rounded-lg p-3 space-y-2">
                ...
                <div className="flex items-center justify-between text-xs text-dark-400">
                  <span>Generated by {(alert.agentName || alert.agentId || alert.agent_id || 'System').charAt(0).toUpperCase() + (alert.agentName || alert.agentId || alert.agent_id || 'System').slice(1)} Agent</span>
