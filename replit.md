...
## Recent Changes  
- **CRITICAL: Fixed Database Query Issue in RM Metrics** - Resolved production £0 revenue issue by switching from raw SQL to TelosIntelligenceService for data consistency; raw SQL queries were returning undefined rows due to different database connection patterns, now uses authentic £52K daily revenue from 1,893 EZY pricing records (2025-08-04)
